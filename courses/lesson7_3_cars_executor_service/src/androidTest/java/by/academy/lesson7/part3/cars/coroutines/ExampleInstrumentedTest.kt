package com.example.lesson7.part3.cars.coroutines

import android.util.Log
import androidx.test.ext.junit.runners.AndroidJUnit4
import androidx.test.platform.app.InstrumentationRegistry
import by.academy.lesson7.part3.data.DatabaseInfo
...
class ExampleInstrumentedTest {
    ...
    fun `useAppContext`() {
        ...
        assertEquals("by.academy.lesson7.part3", appContext.packageName)
    }
